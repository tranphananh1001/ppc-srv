    ...
    .controller('ManagerCampaignSKUController', [
      ...
      function controller($scope, $rootScope, $state, $stateParams, MessageService, HomeModel, $filter,
        ...
        UserService, CampaignModel, CampaignLogModel, DTOptionsBuilder, $timeout) {
          ...
          $stateParams.campaignname = $rootScope.decodeURL($stateParams.campaignname);
          ...
          //Load all ad group by campaign name
          $scope.loadAllAdGroupByCampaignName = function() {
            CampaignModel.getAllAdGroupByCampaignName({
              user: $scope.user.id,
          ...
          $scope.loadAllAdGroupByCampaignName();
          ...
          //go keyword page
          $scope.goKeyword = function(item) {
            $rootScope.adGroupName = item["Ad Group Name"];
            var result = { user: $scope.user.id, campaignname: $scope.campaignName, adgroupid: item["Ad Group Id"] };
            $state.go("ppc.managerCampaignSKUKeyword", result);
          };
