        ...
        return [
          {
            ...
            desc: 'Improve conversions, find the best back end search terms and more',
            access: AccessLevels.user
          },
          {
            state: 'ppc.campaign',
            title: 'Campaign Optimization',
            desc: 'Reduce Ad Spend and Analyze Performance',
            access: AccessLevels.user
          },
          {
            state: 'ppc.power',
            title: 'PowerPPC',
            desc: 'Get More Traffic to your listing, KW and ST Expansion Strategies',
            access: AccessLevels.user
          },
          /*{
            state: 'ppc.settings',
      ...
      function factory(_) {
        ...
        var data = {
          'ppc.products': {
            'Backend': [
              {
                url: repository + 'backend/api/models/Product.js',
                title: 'Product.js',
                info: types.generic.model
              },
              {
                url: repository + 'backend/api/controllers/ProductController.js',
                title: 'ProductController.js',
                info: types.generic.controller
              },
              {
                url: repository + 'backend/test/fixtures/Product.json',
                title: 'Product.json',
            ...
            'Frontend': [
              {
                url: repository + 'frontend/src/app/ppc/product/product.js',
                title: 'product.js',
                info: types.frontend.module
              },
              {
                url: repository + 'frontend/src/app/ppc/product/product-controllers.js',
                title: 'product-controllers.js',
                info: types.generic.controller
              },
              {
                url: repository + 'frontend/src/app/ppc/product/product-models.js',
                title: 'product-models.js',
                info: types.generic.model
              },
              {
                url: repository + 'frontend/src/app/ppc/product/list.html',
                title: 'list.html',
          ...
          'ppc.authors': {
            ...
            'Frontend': [
              {
                url: repository + 'frontend/src/app/ppc/author/author.js',
                title: 'author.js',
                info: types.frontend.module
              },
              {
                url: repository + 'frontend/src/app/ppc/author/author-controllers.js',
                title: 'author-controllers.js',
                info: types.generic.controller
              },
              {
                url: repository + 'frontend/src/app/ppc/author/author-models.js',
                title: 'author-models.js',
                info: types.generic.model
              },
              {
                url: repository + 'frontend/src/app/ppc/author/list.html',
                title: 'list.html',
                info: types.generic.template
              }
            ]
          ...
          'ppc.messages': {
            'Frontend': [
              {
                url: repository + 'frontend/src/app/ppc/messages/messages.js',
                title: 'messages.js',
                info: types.frontend.module
              },
              {
                url: repository + 'frontend/src/app/ppc/messages/messages-controllers.js',
                title: 'messages-controllers.js',
                info: types.generic.controller
              },
              {
                url: repository + 'frontend/src/app/ppc/messages/messages.html',
                title: 'messages.html',
                info: types.generic.template
              }
            ],
          ...
          'ppc.chat': {
            ...
            'Frontend': [
              {
                url: repository + 'frontend/src/app/ppc/chat/chat.js',
                title: 'chat.js',
                info: types.frontend.module
              },
              {
                url: repository + 'frontend/src/app/ppc/chat/chat-controllers.js',
                title: 'chat-controllers.js',
                info: types.generic.controller
              },
              {
                url: repository + 'frontend/src/app/ppc/chat/chat-directives.js',
                title: 'chat-directives.js',
                info: types.frontend.directive
              },
              {
                url: repository + 'frontend/src/app/ppc/chat/chat-models.js',
                title: 'chat-models.js',
                info: types.generic.model
              },
              {
                url: repository + 'frontend/src/app/ppc/chat/chat.html',
                title: 'chat.html',
                info: types.generic.template
              }
            ]
